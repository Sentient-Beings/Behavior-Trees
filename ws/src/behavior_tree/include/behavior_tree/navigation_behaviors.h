...
// Node to set the locations from a list 
...
// Node to get the next location from a queue read from a list
...
// Node to go to a target location (basically a wrapper around the NavigateToPose action)
